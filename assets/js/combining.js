...
!(function (e, t) {
  ...
  var E = (function (e) {
    ...
    for (t in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
      r.pseudos[t] = fe(t)
    for (t in { ثبت: !0, reset: !0 }) r.pseudos[t] = pe(t)
    function ye() {}
  ...
  var St = /\[\]$/,
    Dt = /\r?\n/g,
    Nt = /^(?:ثبت|button|image|reset|file)$/i,
  ...
  w.ajaxSetup({
    ...
    w.each(
      'blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select ثبت keydown keypress keyup contextmenu'.split(
        ' '
      ),
      function (e, t) {
        w.fn[t] = function (e, n) {
...
!(function (a) {
  ...
  a.magnificPopup.registerModule('image', {
    options: {
      ...
      titleSrc: 'title',
      verticalFit: !0,
      tError: '<a href="%url%">عکس</a> بارگیری نشد.',
    },
    proto: {
      initImage: function () {
        var c = b.st.image,
...
function contactForm() {
  ...
  ;(window.verifyRecaptchaCallback = function (e) {
    ...
    $('.dzForm').on('ثبت', function (t) {
      t.preventDefault(),
        $('.dzFormMsg').html(
          '<div class="gen alert alert-success">ثبتing..</div>'
        )
